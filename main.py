...
import csv
import sys
from helper import delete_folder,slotlist_generator
inp1 = sys.argv[1] #crsdat
inp2 = sys.argv[2] #scd
inp3 = sys.argv[3] #reg
...
def filemaker(crsdat,scd,outpath):
    ...
    def shift_dct_generator(Slt, crslist,shift):
        ...
        #--------------------
            ...
            file_name = os.getcwd()+f"/SlotList/{Slt}.csv"
    ...
    def make_file():
        ...
        dyslt = day_slots()
        dyslt=dyslt[1:]
        dct={"Enrollment Number":[],"Day":[],"Shift":[],"Course":[],"Slot":[],"LHC NO.":[],"Seat-Number":[]}
        for day in scd:
            dy = day[0]
